        ...
        <div class="offcanvas-body">
            ...
            <td> 
                <div class="profile">
                       ...
                       <h3><a href="changepw.php?usn=<?php echo $Username?>" style="font-size: smaller; margin-top:5mm;"> Ubah Password</a></h3>    
                </div>
            </td>
            <div class="btn0">
                <a href="logout.php" class="btn btn-dark btn-sm"  onclick="return confirm(' Yakin mau keluar? ⊹⋛⋋( ●´⌓`●)⋌⋚⊹')">Out</a>
                <a href="editpfpage.php?usn=<?php echo $Username?>" class="btn btn-dark btn-sm">Edit Profile</a>   
                <a href="adminpage.php " class="btn btn-dark btn-sm">Kas</a> 
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                ...
                <thead class="tabel">
                    <tr>
                        <th class="tabel" scope="col" style="text-align: center;">ID</th>
                        <th class="tabel" scope="col" style="text-align: center;">Nama</th>
                        <th class="tabel" scope="col" style="text-align: center;">Username</th>
                        <th class="tabel" scope="col" style="text-align: center;">Level</th>
                        <th class="tabel" scope="col" style="text-align: center;">Jabatan</th>
                        <th class="tabel" scope="col" style="text-align: center;">Foto</th>
                    </tr>
                </thead>
                <tbody style="text-align: center;">
                <?php
                    $select = mysqli_query($connect,"SELECT * FROM akun ");
                    $i=1;
                ...
                ?>
                    <tr>
                            ...
                            <td ><?php if($show ['Kode']==1){ echo "Admin";} elseif($show ['Kode']==2){ echo "User";}?></td>
                            <td ><?php echo $show ['Jabatan'];?></td>
                            <td >
                                <img src="account/<?php echo $show['Foto'];?>" alt="" style="width: 3cm;heigth:4cm">
                            </td>
                    </tr>
                <?php
                    }
